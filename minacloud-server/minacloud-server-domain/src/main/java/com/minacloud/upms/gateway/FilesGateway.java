...
public interface FilesGateway extends BaseGateway<Files, Long> {
    Files findByOpenId(String param);

    Page<Files> findPage();

    void updatePassword(Long userId, String password);

    Files findByUsername(String param);

    Files findByPhone(String param);
}
