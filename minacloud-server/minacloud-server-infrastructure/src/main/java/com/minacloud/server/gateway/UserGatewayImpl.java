...
public class UserGatewayImpl implements UserGateway {
    ...
    public void saveAll(List<Users> list) {
        List<UsersDO> usersDO = userDOConvertor.toSource(list);
        userRepository.saveAll(usersDO);
    }
